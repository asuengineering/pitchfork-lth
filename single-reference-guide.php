...
/**
 *
 * Single.php template for reference guide posts.
 * References guide_tags in place of the standard categories on the default template.
 *
 * @package pitchfork
 */
				...
				<aside class="secondary">
					<div class="sidebar-wrap">
						...
						<div class="post-meta">
							...
							$categories = get_the_terms( $post->ID ,'guide-tag');
							$categorylist = '';
							if ( ! empty( $categories ) ) {
