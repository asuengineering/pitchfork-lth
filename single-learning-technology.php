<?php
/**
 * Learning Technology CPT - Single
 * Unstyled page template. Depends on blocks for page designs within custom post type.
 * Based on page.php from the parent theme.
 *
 * @package pitchfork
 */
